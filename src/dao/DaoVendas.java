...
public class DaoVendas extends DaoAbstract {
    ...
    public Object list(int id) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(DaoVendas.class); //importar do bean e do hibernate; criteria é pra fazer select * from na O.O
        criteria.add(Restrictions.eq("idvendas", id)); //é um método estático; id é o parametro da linha 46
