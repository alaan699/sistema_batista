 ...
 * @author ENTREPRISE
 */
public class DaoVendasProduto extends DaoAbstract {
    ...
    public Object list(int id) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(DaoVendasProduto.class); //importar do bean e do hibernate; criteria é pra fazer select * from na O.O
